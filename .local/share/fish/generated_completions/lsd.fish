...
complete -c lsd -l color -d 'When to use terminal colours'
complete -c lsd -l icon -d 'When to print the icons'
complete -c lsd -l icon-theme -d 'Whether to use fancy or unicode icons'
...
complete -c lsd -l permission -d 'How to display permissions'
complete -c lsd -l size -d 'How to display size'
complete -c lsd -l total-size -d 'Display the total size of directories'
complete -c lsd -l date -d 'How to display date [possible values: date, relative, +date-time-format]'
...
complete -c lsd -l sort -d 'sort by WORD instead of name'
...
complete -c lsd -l group-dirs -d 'Sort the directories then the files'
complete -c lsd -l group-directories-first -d 'Groups the directories at the top before the files'
complete -c lsd -l blocks -d 'Specify the blocks that will be displayed and in what order'
...
complete -c lsd -s I -l ignore-glob -d 'Do not display files/directories with names matching the glob pattern(s)'
...
complete -c lsd -l hyperlink -d 'Attach hyperlink to filenames'
